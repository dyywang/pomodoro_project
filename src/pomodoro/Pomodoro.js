...
import AdjustDurations from "./AdjustDurations.js"
...
function Pomodoro() {
  ...
  return (
    <div className="pomodoro">
      <AdjustDurations session={session} durations={durations} setDurations={setDurations} formatTime={formatTime} />
      <div className="row">
        <div className="col">
          <div
      ...
      <SessionDisplay session={session} durations={durations} formatTime={formatTime}/>
    </div>
  );
}
